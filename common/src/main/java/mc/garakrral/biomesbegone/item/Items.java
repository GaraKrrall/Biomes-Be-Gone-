package mc.garakrral.biomesbegone.item;
...
public class Items {
    public static final Identifier MAPLE_BOAT_ID = Identifier.fromNamespaceAndPath(Main.MOD_ID, "maple");

    public static final Item MAPLE_SIGN = registerStandingSign("maple_sign",
            Blocks.STANDING_MAPLE_SIGN, Blocks.WALL_MAPLE_SIGN);
    public static final Item HANGING_MAPLE_SIGN = registerHangingSign("maple_hanging_sign",
            Blocks.HANGING_MAPLE_SIGN, Blocks.WALL_HANGING_MAPLE_SIGN);
    public static final Item MAPLE_BOAT = registerItem("maple_boat",
            settings -> new BoatItem(BBEntityTypes.MAPLE_BOAT, settings.stacksTo(1)));
    public static final Item MAPLE_CHEST_BOAT = registerItem("maple_chest_boat",
            settings -> new BoatItem(BBEntityTypes.MAPLE_CHEST_BOAT, settings.stacksTo(1)));
    ...
    public static final Item TAPPED_BUCKET = registerItem("tapped_bucket",
            createAliasedBlockItem(Blocks.TAPPED_BUCKET));
    ...
    public static final Item PANCAKE = registerItem("pancake",
            settings -> new Item(settings.food(FoodComponents.PANCAKE)));
    public static final Item MAPLE_PANCAKE = registerItem("maple_pancake",
            settings -> new Item(settings.food(FoodComponents.MAPLE_PANCAKE)));
    public static final Item CHOCOLATE_PANCAKE = registerItem("chocolate_pancake",
            settings -> new Item(settings.food(FoodComponents.CHOCOLATE_PANCAKE)));
    public static final Item PANCAKE_STACK = registerItem("pancake_stack",
            settings -> new Item(settings.food(FoodComponents.PANCAKE_STACK)));
    public static final Item MAPLE_PANCAKE_STACK = registerItem("maple_pancake_stack",
            settings -> new Item(settings.food(FoodComponents.MAPLE_PANCAKE_STACK)));
    public static final Item CHOCOLATE_PANCAKE_STACK = registerItem("chocolate_pancake_stack",
            settings -> new Item(settings.food(FoodComponents.CHOCOLATE_PANCAKE_STACK)));
