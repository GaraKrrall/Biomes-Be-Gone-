package mc.garakrral.biomesbegone.entity;
...
public class BBEntityTypes {
    public static EntityType<Boat> MAPLE_BOAT = register(
            "maple_boat", EntityType.Builder.of(boatFactory(() -> Items.MAPLE_BOAT), MobCategory.MISC)
    ...
    public static EntityType<ChestBoat> MAPLE_CHEST_BOAT = register(
            "maple_chest_boat", EntityType.Builder.of(chestBoatFactory(() -> Items.MAPLE_CHEST_BOAT), MobCategory.MISC)
                    .noLootTable().sized(1.375F, 0.5625F).eyeHeight(0.5625F).clientTrackingRange(10)
    );
    ...
    private static <T extends Entity> EntityType<T> register(String name, EntityType.Builder<T> builder) {
        ...
        return Registry.register(BuiltInRegistries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(Main.MOD_ID, name), type);
    }
